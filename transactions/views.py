...
class DepositMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        transaction_mail_send(self.request.user,"Deposite MAil",amount,'transactions/deposite_mail.html')
...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        transaction_mail_send(self.request.user,"Withdrawal Mail",amount,'transactions/withdraw_mail.html')
...
class LoanRequestView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        transaction_mail_send(self.request.user,"Loan Request Mail",amount,'transactions/loan_mail.html')
